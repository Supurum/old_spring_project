...
<div class="container-fluid">
	<div class="row">
		...
		<form role="form" action="/messages/replyPost" method="post">
			<div class="form-group">					 
				<label for="targetid">
					받는사람
				</label>
				<input type="text" class="form-control" id="targetid" name="targetid" value="${targetid }" readonly  style='width:200px'/>
			</div>
			<div class="form-group">
				<label for="message">
					내용
