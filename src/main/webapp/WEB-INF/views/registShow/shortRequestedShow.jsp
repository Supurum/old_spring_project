...
<script>
	$(document).ready(function(){
		...
		$(".btnOk").click(function(){
			...
			var meet_partner =$(this).attr('data-meet-partner');
			var parent_tr = $(this).parents('tr');
			console.log('meet_num', meet_num);
			console.log('meet_partner', meet_partner);
			...
			<table class="table table-bordered">
				...
				<c:forEach items="${list}" var="vo">
					...
					<tr>
						...
						<td>
							<input type="button" class="btnOk" value="수락" data-join-idx="${ vo.meet_num }" data-meet-partner="${vo.user_id}"   />
