...
@Repository
public class LongMeetDAOImpl implements LongMeetDAO {
	...
	public List<MatchRegisterVO> longUserList(int page) throws Exception {
		...
		return sqlSession.selectList(NAMESPACE + ".longUserList", paramMap);
	}
	...
	public UserInfoDTO detailInfo(String user_id) throws Exception {
		return sqlSession.selectOne(NAMESPACE + ".detailInfo",user_id);
	}
