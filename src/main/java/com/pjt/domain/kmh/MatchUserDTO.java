...
public class MatchUserDTO {
	...
	public String toString() {
		return "MatchUserDTO [user_id=" + user_id + ", user_name=" + user_name + ", user_age=" + user_age
				+ ", user_photo=" + user_photo + ", gender_name=" + gender_name + ", religion_name=" + religion_name
				+ ", loc_name=" + loc_name + "]";
	}

	public MatchUserDTO(String user_id, String user_name, int user_age, String user_photo, String gender_name,
